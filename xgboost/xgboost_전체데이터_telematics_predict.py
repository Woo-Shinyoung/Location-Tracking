...
prediction_result_filename = f'prediction_result_XGBOOST_{file_basename}.csv'
map_html_filename = f'map_XGBOOST_{file_basename}.html'
...
for i in range(len(ternaltime_pred) - 1):
    # print(ternaltime)
